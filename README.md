...
```bash
python edge_classification.py --no_pre --dataset_name hyperlink --model_name GraphMixer --load_best_configs --seed 0 --batch_size 3000
python edge_classification.py --dataset_name hyperlink --model_name GraphMixer --load_best_configs --seed 0 --batch_size 3000
python edge_classification.py --classifier learnable --no_pre --dataset_name hyperlink --model_name GraphMixer --load_best_configs --seed 0
