...
from models.modules import LinkPredictorBaseline, LinkPredictor, EdgeClassifierBaseline
...
if __name__ == "__main__":
    ...
    for run in range(args.num_runs):
        ...
        args.save_model_name = f'edge_classification_baseline_seed{args.seed}' + (f'--no_pre' if args.no_pre else '')
